...
@Service(value="metaqrcode-server-services-JsonRestCatalogServiceImpl")
...
/**
 * expose metaqrcode catalog entry (XSD) services as REST json
 * 
...
public class JsonRestCatalogServiceImpl extends CatalogServiceImpl {
	 ...
	 */
	public ResponseCatalogUpload upload(@Multipart(type="*/json") RequestCatalogUpload request, @Multipart(required=true, value="xsd", type="*/xml") byte[] xsd, @Context HttpServletResponse httpServletResponse) {
