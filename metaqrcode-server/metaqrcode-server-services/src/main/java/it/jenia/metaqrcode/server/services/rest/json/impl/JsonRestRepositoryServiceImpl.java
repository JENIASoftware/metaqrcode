package it.jenia.metaqrcode.server.services.rest.json.impl;
...
@Service(value="metaqrcode-server-services-JsonRestRepositoryServiceImpl")
...
/**
 * expose metaqrcode repository entry (XML) services as REST json
 * 
...
public class JsonRestRepositoryServiceImpl extends RepositoryServiceImpl {
	 ...
	 */
	public ResponseRepositoryUpload upload(@Multipart(type="*/json") RequestRepositoryUpload request, @Multipart(required=true, value="xml", type="*/xml") byte[] xml, @Context HttpServletResponse httpServletResponse) {
	 ...
	 */
	public ResponseRepositoryUpdate update(@Multipart(type="*/json") RequestRepositoryUpdate request, @Multipart(required=true, value="xml", type="*/xml") byte[] xml, @Context HttpServletResponse httpServletResponse) {
